...
# Function 1: format_recipe_output 
# Formats the recipe suggestions into a structured Markdown table (Ensures the output is user-friendly and visually appealing)
...
# Function 2: format_analysis_output 
# Formats the nutritional analysis results into a structured Markdown table (Ensures the output is user-friendly and visually appealing)
...
def analyze_food(image, dietary_restrictions, workflow_type, progress = gr.Progress(track_tqdm = True)):
    ...
    inputs = {'uploaded_image': image_path,
              'dietary_restrictions': dietary_restrictions,
              'workflow_type': workflow_type}
    
    if workflow_type == "recipe":
        crew_instance = NourishBotRecipeCrew(image_data = image_path, dietary_restrictions = dietary_restrictions)
