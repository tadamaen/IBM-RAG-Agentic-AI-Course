...
# # Core UI (stable with Python 3.12)
# !pip install gradio==4.29.0
# !pip install jinja2==3.1.4

# # LangChain stack (compatible set)
...
# Create interface
demo_echo = gr.ChatInterface(fn = echo_chatbot,
                             title = "Echo Chatbot",
                             description = "A simple chatbot that echoes your messages.",
                             examples = ["Hello!", "How are you?", "Tell me about restaurants."])
...
test_messages = ["I'm looking for Italian restaurants", "How do I make pad thai?", "Give me dinner ideas", "What can you do?"]
...
# Test the preference extraction function
...
def run_recommendation_workflow(preferences: Dict[str, Any], recommendation_type: str) -> Dict[str, Any]:
    ...
    mock_recommendations = {"restaurants": [{"name": "Green Leaf Bistro",
                                             "cuisine": "Mediterranean",
                                             "price": "$$",
                                             "reasoning": """This restaurant perfectly aligns with your preference for healthy, plant-based options and offers a diverse Mediterranean 
                                                             menu with excellent vegetarian choices."""},
                                            {"name": "Spice Route",
                                             "cuisine": "Indian",
                                             "price": "$$",
                            ...
                            "recipes": [{"name": "One-Pot Chickpea Curry",
                                         "cuisine": "Indian",
                                         "difficulty": "Easy",
...
with gr.Blocks(title = "Food Recommendation Chatbot", theme = gr.themes.Soft()) as demo:
    ...
    with gr.Tabs():
        with gr.Tab("💬 Chat"):
            chatbot_interface = gr.ChatInterface(fn = recommendation_chatbot,
                                                 examples = ["I'm looking for vegetarian restaurants", "Suggest some easy recipes for dinner", "I want spicy Thai food recommendations", "What can you help me with?"],
        ...
        with gr.Tab("➕ Add Restaurant"):
            ...
            add_rest_btn.click(fn = add_restaurant, inputs = [rest_name, rest_cuisine, rest_price, rest_location, rest_description], outputs = rest_output)
        ...
        with gr.Tab("➕ Add Recipe"):
            ...
            add_recipe_btn.click(fn = add_recipe,
